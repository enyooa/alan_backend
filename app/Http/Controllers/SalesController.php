...
return response()->json($salesTransformed);
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'product_subcard_id' => 'required|uuid|exists:product_subcards,id', // Ensure the subcard exists
    ...
    public function bulkStore(Request $request)
{
    ...
    try {
        ...
        $validated = $request->validate([
            ...
            'sales.*.product_subcard_id' => 'required|uuid|exists:product_sub_cards,id',
...
public function update(Request $request, $id)
{
    ...
    $validated = $request->validate([
        'product_subcard_id' => 'nullable|uuid|exists:product_sub_cards,id',
