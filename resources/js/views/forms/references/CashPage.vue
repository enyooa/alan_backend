<template>
    <div class="cash-form">
      <h2 class="form-title">Создать счет</h2>
      <form @submit.prevent="submitCash">
        <div class="form-group">
          ...
          <input
            type="text"
            v-model="cashName"
            placeholder="Введите наименование счета (например, касса1)"
            required
          />
        </div>
    ...
    methods: {
      async submitCash() {
        ...
        try {
          ...
          // POST to your chosen endpoint, e.g. /api/create_cash
          // or /api/references/cash, whichever you use
